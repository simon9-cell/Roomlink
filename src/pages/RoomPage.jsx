          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
              ...
              <p className="text-slate-500 text-sm max-w-xs mb-8">
                Try adjusting your filters or clearing your search to find more roommates.
              </p>
              <button onClick={handleReset} className="bg-blue-600 text-white px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest active:scale-95 transition-all shadow-lg shadow-blue-100">
                Clear all filters
              </button>
            </div>
          )}
